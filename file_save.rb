...
save_file_choo = Gtk::FileChooser.new(
        "Save a File", Gtk::FileChooser::ACTION_SAVE)
save_file_choo.current_name = "lena256.bmp"
...
window.add(save_file_choo)
window.add(choo_file_btt)
window.show_all
Gtk.main
